...
:img-build-status: https://dev.azure.com/sonarsource-cfamily-examples/windows-cmake-azure-sq/_apis/build/status/sonarsource-cfamily-examples.linux-cmake-azure-sq
